...
return [
	...
	*/
	...
	'admin' => [
		...
		*/
		'users' => [
			'${EXPOSE_SERVER_ADMIN_USERNAME}' => '${EXPOSE_SERVER_ADMIN_PASSWORD}',
		],
		...
		*/
		'messages' => [
			...
			'custom_subdomain_unauthorized' => 'You are not allowed to specify custom subdomains. Assigning a random subdomain instead.',
